...
- 2025-12-02: Block-Mappings werden erst über alle `options.blocks` aggregiert, bevor `conditionImport` Namen per Index vergeben werden, damit Keys aus mehreren Block-Ordnern eindeutige Conditions behalten.
